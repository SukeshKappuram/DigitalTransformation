      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu">
            <li><a href="flows">Customer</a></li>
            <li class="divider"></li>
            <li><a href="admin">Admin</a></li>
          </ul>
        </li>          
        <li ><a href="ProductInfo?p=<%=p%>">All Products<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-th-list"></span></a></li>        
	...
	<div class="container">
    	...
    	<div class="carousel-inner" role="listbox">
      		<div class="item active">
        		<img src="<c:url value="/resources/images/p01.jpg" />" alt="img1" style="border-radius:10px;"/>
      		</div>
      		<div class="item">
        		<img src="<c:url value="/resources/images/p02.jpg" />" alt="img2" style="border-radius:10px;"/>
      		</div>
      		<div class="item">
        		<img src="<c:url value="/resources/images/p03.jpg" />" alt="img3" style="border-radius:10px;"/>
      		</div>
    	</div>
		</div>
	</div>
